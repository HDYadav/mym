    ...
    <div class="form-row">
      <div class="form-holder">
        <label for="exampleSpouseName">Spouse Name</label>             
            <input type="text" name="spouse_name" id="spouse_name" value="spouserName" class="form-control" value=""  placeholder="Enter Spouse Name" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter  first name" >
      </div>
        <div class="form-holder">
...
<script>
  ...
  $("#container").html(" ");
    ...
    var text;
    for(i = 1; i <= val; i++) {
        $("#container").append('<strong>Details of Child '+ i +'</strong><hr><div class="form-row"><div class="form-holder"><label for="exampleSpouseName">Prefix </label> {{Form::select('prefix[]',Helper::prefix(), 1, ['class' => 'form-control','required data-parsley-trigger'=>'keyup','data-parsley-required-message'=>'Please prefix'])}}</div><div class="form-holder"><label for="exampleSpouseName">First Name </label><input type="text" name="first_name[]" id="first_name" class="form-control" value="First Name"  placeholder="Enter First Name" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter first name"></div><div class="form-holder"><label for="exampleSpouseName">Middle Name </label><input type="text" name="middle_name[]" id="middle_name" class="form-control" value="middle_name"  placeholder="Enter Middle Name" ></div><div class="form-holder"><label for="exampleSpouseName">Last Name </label><input type="text" name="last_name[]" id="last_name" class="form-control" value="last_name"  placeholder="Enter Last Name" required data-parsley-trigger="keyup" data-parsley-required-message="Please enter last name"></div></div><div class="form-row"><div class="form-holder"><label for="exampleSpouseName">Date Of Birth</label>{{ Form::date('dob[]', \Carbon\Carbon::now(),['class' => 'form-control'])}} </div><div class="form-holder"><label for="exampleSpouseName">Area of interest</label><input type="text" name="area_of_interest[]" id="area_of_interest" class="form-control" value="cricket"  placeholder="Enter Area of interest" required data-parsley-trigger="keyup" data-parsley-required-message="Please area of interest"></div><div class="form-holder"><label for="exampleSpouseName">Achievement</label><input type="text" name="achievement[]" id="achievement" class="form-control" value="achivment" placeholder="Enter Achievement" required data-parsley-trigger="keyup" data-parsley-required-message="Please achievement"></div></div>');
    }   
